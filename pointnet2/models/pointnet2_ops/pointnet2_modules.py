...
class Mlp_plus_t_emb(nn.Module):
    ...
    def forward(self, feature, t_emb=None, condition_emb=None, second_condition_emb=None):
        ...
        h = feature
        h = self.first_mlp(h)  #2-stage(B, mlp_spec[1], N, 1)
...
class PointnetFPModule(nn.Module):
    ...
    def forward(self, unknown, known, unknow_feats, known_feats, t_emb=None, condition_emb=None, 
        ...
        unknown : torch.Tensor
            (B, n, 3) tensor of the xyz positions of the unknown features(original points)
        known : torch.Tensor
            (B, m, 3) tensor of the xyz positions of the known features(center points)
